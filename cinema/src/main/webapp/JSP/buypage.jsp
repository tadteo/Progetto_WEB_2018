            ...
            <li><b>Poltrona N:${posto.getPoltrona()} alla riga N:${posto.getRiga()}</b> - E' per un cliente con tariffa ridotta? 
              <form class="form-inline">
                <div class="form-group switch-field">
                  <input type="radio" posto_id="${posto.getId()}" id="switch_left_${posto.getRiga()}${posto.getPoltrona()}" name="switch_${posto.getRiga()}${posto.getPoltrona()}" value="no" checked onclick="setTotale(); setPrezzo(${posto.getRiga()},${posto.getPoltrona()});"/>
                  <label for="switch_left_${posto.getRiga()}${posto.getPoltrona()}">NO</label>
                  <input type="radio" posto_id="${posto.getId()}" id="switch_right_${posto.getRiga()}${posto.getPoltrona()}" name="switch_${posto.getRiga()}${posto.getPoltrona()}" value="yes"  onclick="setTotale(); setPrezzo(${posto.getRiga()},${posto.getPoltrona()})"/>
