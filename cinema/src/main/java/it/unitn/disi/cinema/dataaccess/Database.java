 ...
 * E' implementata con paradigma singleton quindi non può essere instanziata dall'esterno.
 * Viene istanziata una singola volta alla sua creazione e la sua unica istanza può essere
 * ottenuta attraverso il metodo statico getInstance()
 * L'obiettivo di questa scelta è di permettere una sola connessione alla volta al database attuale
 * @author domenico
 */
