 ...
 * 
 ...
 Posto getPostoById(Integer id)
 List<Posto> getPostoBySalaId(Integer salaId)
 List<Posto> getAll()
 * void updatePosto(Posto posto)
 void deletePosto(Integer id)
 * 
 * void setAvailability(Integer Id, Boolean available)
 * Boolean isAvailableForReservation(Posto posto)
 * List<Boolean> getSalaMap(Integer salaId)
 * 
 * @author domenico
 */
