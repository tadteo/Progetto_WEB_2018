 ...
 * 
 * CRUD
 * Metodi disponibili per Prenotazione:
 * 
 * void addPrenotazione(Prenotazione prenotazione)
 * 
 * Prenotazione getPrenotazioneById(Integer id)
 * List<Prenotazione> getAll() //In futuro si potrebbe mettere parametro limit
 * List<Prenotazione> getAfter(Timestamp time)
 * List<Prenotazione> getByUtente(Integer idUtente)
 * List<Prenotazione> getByUtenteAfter(Integer idUtente, Timestamp time)
 * List<Prenotazione> getByFilm(Integer idFilm)
 * List<Prenotazione> getByFIlmAfter(Integer idFilm, Timestamp time)
 * List<Prenotazione> getBySpettacolo(Integer idSpettacolo)
 * List<Prenotazione> getBySpettacoloAfter(Integer idSpettacolo, Timestamp time)
 * 
 * //No update
 * 
